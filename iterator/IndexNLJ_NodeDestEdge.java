...
public class IndexNLJ_NodeDestEdge extends NestedLoopsJoins {
    ...
    private static CondExpr _buildJoinCond() {
        ...
        cond.operand2.symbol = new FldSpec(new RelSpec(RelSpec.innerRel), Edge.FLD_DST_LABEL);
     ...
     */
    public IndexNLJ_NodeDestEdge(int amt_of_mem, CondExpr rightFilter, FldSpec[] proj_list, int n_out_flds)

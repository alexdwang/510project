...
public class NHFPage extends Page 
  ...
  */
   ...
   * open a HFPage and make this NHFpage piont to the given page
   ...
   * @exception IOException I/O errors
   * in C++ Status insertRecord(char *recPtr, int recLen, NID& rid)
   */
  ...
  /**
   * returns a tuple in a byte array[pageSize] with given NID rid.
   * <br>
  ...
  public Node returnRecord ( NID rid )
	  ...
	  && (pageNo.pid == curPage.pid))
	{
	  ...
	  offset = getSlotOffset (slotNo);
	  Node tuple = new Node(data, offset);
	  return tuple;
	}

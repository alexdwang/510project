...
public class NScan implements GlobalConst{
    ...
    /** PageId of current directory page (which is itself an NHFPage) */
  ...
  //    System.err.println("SCAN: Error in NScan" + e);
      e.printStackTrace();
    }   
     ...
     *			false otherwise.
     */
  public boolean position(NID rid) 
    throws InvalidTupleSizeException,
	   IOException
  { 
    NID    nxtrid = new NID();
	   ...
	   IOException
  {
	...
	//	System.err.println("SCAN: Chain Error in NScan: " + e);
		e.printStackTrace();
	}		
  ...
  //        dirpage = NULL;  datapageId = INVALID_PAGE
	...
	//  System.err.println("NScan: Chain Error: " + e);
	  e.printStackTrace();
	}
  ...
  // - current datapage pinned
    ...
    // data page is not yet loaded: read its record from the directory page
	  ...
	  System.err.println("HeapFile: Error in NScan" + e);
	}
  ...
  private boolean peekNext(NID rid) {
  ...
  private void pinPage(PageId pageno, Page page, boolean emptyPage)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"NScan.java: pinPage() failed");
    }
  ...
  private void unpinPage(PageId pageno, boolean dirty)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"NScan.java: unpinPage() failed");
    }

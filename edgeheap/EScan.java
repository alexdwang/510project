...
/**	
 * A EScan object is created ONLY through the function openScan
...
public class EScan implements GlobalConst{
  ...
  //    System.err.println("SCAN: Error in EScan" + e);
      e.printStackTrace();
    }   
	   ...
	   IOException
  {
	...
	try {
          rectuple = dirpage.getEdge(datapageRid);
	}  
				
	catch (Exception e) {
	//	System.err.println("SCAN: Chain Error in EScan: " + e);
		e.printStackTrace();
	}		
  ...
  //        dirpage = NULL;  datapageId = INVALID_PAGE
	...
	//  System.err.println("EScan: Chain Error: " + e);
	  e.printStackTrace();
	}
  ...
  // - current datapage pinned
    ...
    // data page is not yet loaded: read its record from the directory page
	  ...
	  System.err.println("HeapFile: Error in EScan" + e);
	}
  ...
  private void pinPage(PageId pageno, Page page, boolean emptyPage)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"EScan.java: pinPage() failed");
    }
  ...
  private void unpinPage(PageId pageno, boolean dirty)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"EScan.java: unpinPage() failed");
    }

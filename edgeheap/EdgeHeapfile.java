...
public class EdgeHeapfile implements Filetype,  GlobalConst {
  ...
  */
  ...
  /* Internal HeapFile function (used in getEdge and updateRecord):
  ...
  */
   ...
   * @exception Exception other exception
   *
   * @return a Edge. if Edge==null, no more tuple
   */
  ...
  private void pinPage(PageId pageno, Page page, boolean emptyPage)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"EdgeHeapfile.java: pinPage() failed");
    }
  ...
  private void unpinPage(PageId pageno, boolean dirty)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"EdgeHeapfile.java: unpinPage() failed");
    }
  ...
  private void freePage(PageId pageno)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"EdgeHeapfile.java: freePage() failed");
    }
  ...
  private PageId newPage(Page page, int num)
    ...
    try {
      ...
      throw new HFBufMgrException(e,"EdgeHeapfile.java: newPage() failed");
    }
  ...
  private PageId get_file_entry(String filename)
    ...
    try {
      ...
      throw new HFDiskMgrException(e,"EdgeHeapfile.java: get_file_entry() failed");
    }
  ...
  private void add_file_entry(String filename, PageId pageno)
    ...
    try {
      ...
      throw new HFDiskMgrException(e,"EdgeHeapfile.java: add_file_entry() failed");
    }
  ...
  private void delete_file_entry(String filename)
    ...
    try {
      ...
      throw new HFDiskMgrException(e,"EdgeHeapfile.java: delete_file_entry() failed");
    }

...
public class EHFPage extends Page 
  ...
  */
   ...
   * open a EHFPage and make this HFpage piont to the given page
   ...
   * @exception IOException I/O errors
   * in C++ Status insertEdge(char *recPtr, int recLen, EID& eid)
   */
   ...
   * @exception IOException I/O errors
   * in C++ Status deleteEdge(const EID& eid)
   */
   ...
   * @exception  IOException I/O errors
   * in C++ Status firstEdge(EID& firstRid)
   * 
   */ 
   ...
   * @exception  IOException I/O errors
   * in C++ Status nextEdge (EID curRid, EID& nextRid)
   */
   ...
   * <br>
   * Status getEdge(EID eid, char *recPtr, int& recLen)
   * @param	eid 	the record ID
   ...
   * <br>
   * in C++	Status returnEdge(EID eid, char*& recPtr, int& recLen)
   * @param       eid     the record ID
  ...
  public Edge returnEdge ( EID eid )
	  ...
	  && (pageNo.pid == curPage.pid))
	{
	  ...
	  offset = getSlotOffset (slotNo);
	  Edge tuple = new Edge(data, offset);
	  return tuple;
	}
   ...
   * @return true if the EHFPage is has no records in it, false otherwise  
   * @exception  IOException I/O errors
   */
  ...
  /**
   * Compacts the slot directory on an EHFPage.
